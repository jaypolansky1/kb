...
## Step 2 — Find the login screen on the Concept2 website

Click the **LOGIN** button in the upper right.

![Step 2](./CSV/Step-2.png)
...
## Step 5 — Export the CSV file

Click the **CSV** button next to a season.

![Step 5](./CSV/Step-5.png)
...
![Step 7](./CSV/Step-7.png)

## Step 8 - Select the CSV file
