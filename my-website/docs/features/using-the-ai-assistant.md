...
* Total sessions, total distance, and total time on the erg
* How many sessions beat your pace goal, and what percentage that is
* Your average, best, and worst pace per 500m
* Your average stroke rate
* Your most recent sessions in detail — date, pace, stroke rate, distance, and watts
...
* "Why do my faster sessions have higher stroke rates? Should I fix that?"
* "Design a workout to help me get under my goal pace more consistently."
* "Compare my last five sessions — which was the best and why?"
...
* Use it after a sync. The AI reads your latest data, so sync your newest workouts first to get advice that includes them.
