...
1. On the login page, click Forgot password? and choose the email reset option.
2. Enter the email address on your account and submit. If an account with that email exists, we'll send a 6-character reset code.
3. Check your inbox (and spam folder) for the code.
4. Enter the code along with your new password.
...
1. Click Forgot password? and choose the security question option.
2. Enter your username (not email) — we'll show you your security question.
