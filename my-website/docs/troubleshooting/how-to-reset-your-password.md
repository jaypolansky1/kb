...
Locked out? Chase The Split gives you two ways back in: an email reset code, or your security question. Both start from the "Forgot your password ?" link on the login page.

## Option 1 — Email reset code

1. On the login page, click the "Forgot our password ?" link. 
...
![Step 2](./Password/Security-Question.png)
